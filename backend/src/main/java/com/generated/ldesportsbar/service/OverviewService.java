...
public class OverviewService {
  ...
  private LeaderboardData buildDailyLeaderboard() {
    return new LeaderboardData(
      ...
      "ALL",
      List.of(
        new LeaderboardItem(1, "M007", "一枪爆头", null, 7, 300, "5小时0分", 1, "CS2"),
        new LeaderboardItem(2, "M001", "电竞小王子", null, 5, 120, "2小时0分", 1, "英雄联盟"),
        new LeaderboardItem(3, "M010", "上分机器", null, 6, 300, "5小时0分", 1, "无畏契约"),
        new LeaderboardItem(4, "M003", "游戏达人", null, 6, 390, "6小时30分", 2, "英雄联盟"),
        new LeaderboardItem(5, "M002", "暗夜游侠", null, 4, 180, "3小时0分", 1, "英雄联盟"),
        new LeaderboardItem(6, "M005", "全图视野", null, 5, 90, "1小时30分", 1, "绝地求生"),
        new LeaderboardItem(7, "M008", "五杀专业户", null, 5, 180, "3小时0分", 1, "王者荣耀"),
        new LeaderboardItem(8, "M006", "残血反杀", null, 4, 120, "2小时0分", 1, "无畏契约"),
  ...
  private LeaderboardData buildWeeklyLeaderboard() {
    return new LeaderboardData(
      ...
      "ALL",
      List.of(
        new LeaderboardItem(1, "M008", "五杀专业户", null, 5, 780, "13小时0分", 2, "英雄联盟"),
        new LeaderboardItem(2, "M007", "一枪爆头", null, 7, 840, "14小时0分", 2, "CS2"),
        new LeaderboardItem(3, "M005", "全图视野", null, 5, 570, "9小时30分", 2, "英雄联盟"),
        new LeaderboardItem(4, "M003", "游戏达人", null, 6, 810, "13小时30分", 3, "英雄联盟"),
        new LeaderboardItem(5, "M010", "上分机器", null, 6, 660, "11小时0分", 2, "英雄联盟"),
  ...
  private LeaderboardData buildMonthlyLeaderboard() {
    return new LeaderboardData(
      ...
      "ALL",
      List.of(
        new LeaderboardItem(1, "M008", "五杀专业户", null, 5, 3180, "53小时0分", 8, "英雄联盟"),
        new LeaderboardItem(2, "M007", "一枪爆头", null, 7, 3240, "54小时0分", 7, "CS2"),
